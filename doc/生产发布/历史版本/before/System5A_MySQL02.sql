...
(
   ...
   role_manage          bool NULL DEFAULT 0 comment '是否管理员角色',
   valid                bool NULL DEFAULT 1 comment '是否有效',
   memo                 varchar(255) NULL comment '备注',
   create_time          datetime NULL DEFAULT CURRENT_TIMESTAMP(0) comment '创建时间',
   create_by            varchar(50) NULL DEFAULT NULL comment '创建者',
...
(
   ...
   enabled              bool NULL DEFAULT 1 comment '是否停用',
   credentials_non_expired bool NULL DEFAULT 1 comment '凭证是否过期',
   account_non_expired  bool NULL DEFAULT 1 comment '账户过期',
   account_non_locked   bool NULL DEFAULT 1 comment '账户锁定',
   valid                bool NULL DEFAULT 1 comment '是否有效',
   memo                 varchar(255) NULL comment '备注',
   create_time          datetime NULL DEFAULT CURRENT_TIMESTAMP(0) comment '创建时间',
   create_by            varchar(50) NULL DEFAULT NULL comment '创建者',
