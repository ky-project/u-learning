...
<head>
    ...
    <link rel="stylesheet" href="${Request["systemSuffix"]}${request.contextPath}/static/adminlte/plugins/iCheck/square/blue.css">
...
<script src="${Request["systemSuffix"]}${request.contextPath}/static/adminlte/plugins/iCheck/icheck.min.js"></script>
<script src="${Request["systemSuffix"]}${request.contextPath}/static/js/login.1.js"></script>
