...
<#-- echarts -->
<script src="${Request["systemSuffix"]}${request.contextPath}/static/plugins/echarts/echarts.common.min.js"></script>
<script src="${Request["systemSuffix"]}${request.contextPath}/static/js/index.js"></script>
</body>
</html>
